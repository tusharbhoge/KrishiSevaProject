    ...
    <div className='authContainer h-[90vh] w-[50vw] bg-cover bg-center  flex justify-center items-center ' style={{ backgroundImage:`url(${authBgImage})`}}>
      <div className='h-full w-full bg-gray-300 bg-opacity-60 flex flex-col justify-center items-center'>
          ...
          <div className='flex flex-col justify-center items-center w-[75%] h-auto text-black  '>
            <h1 className='text-3xl font-bold p-3 text-green-900'>
             Register Here
            </h1>
            
            <div className='w-[100%] h-auto flex flex-col p-4 border-2 border-gray-500 rounded-lg text-xl font-semibold bg-white '>
            <input type='text'placeholder='First Name' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400 ' required/>   
            <input type='text'placeholder='Last Name' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400 ' required/>
            <input type='text'placeholder='Email' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400 ' required/>  
            <input type='text'placeholder='Password' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400 ' required/>
            <input type='text'placeholder='Phone Number' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400 ' required/>
            <input type='text' placeholder='AdharCard Number' className=' w-full rounded-2xl py-2 px-4 my-1 focus:outline-none bg-transparent border-2 border-gray-400' required/>
